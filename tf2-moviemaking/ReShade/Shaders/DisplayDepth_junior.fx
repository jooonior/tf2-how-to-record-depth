...
uniform float fUIDepthMin <
	ui_type = "drag";
	ui_label = "Depth Min";
	ui_tooltip = "Adjust minimum depth distance.";
	ui_min = 0.0; ui_max = 1.0;
	ui_step = 0.001;
> = 0.0;

uniform float fUIDepthMax <
	ui_type = "drag";
	ui_label = "Depth Max";
	ui_tooltip = "Adjust maximum depth distance.";
	ui_min = 0.0; ui_max = 1.0;
	ui_step = 0.001;
> = 1.0;
...
float GetDepth(float2 texcoord)
{
	...
	depth = (depth - fUIDepthMin) / (fUIDepthMax - fUIDepthMin);
...
technique DisplayDepth_junior <
	ui_tooltip = "DisplayDepth but with two extra sliders.\n";
>
{
	pass
	{
